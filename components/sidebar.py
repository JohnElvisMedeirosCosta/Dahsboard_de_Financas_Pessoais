...
# ========= Layout ========= #
layout = dbc.Col([
                html.H1("MyBugdet", className="text-primary"), 
                html.P("By JC Analytics", className="text-info"),
                html.Hr(),
    # Seção PERFIL --------------------
    ...
    # Seção NOVO ----------------------
                    ...
                    dbc.ModalBody([
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                ...
                                dbc.Select(
                                    id='select_receita',
                                    options=[{'label': i, 'value': i} for i in globals.cat_receita],
                                    value=globals.cat_receita[0]
                                )
                            ], width=4)
                ...
                ],  style={'background-clor': 'rgba(17, 140, 79, 0.05)'},
                    ...
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Label('Descrição: '),
                                dbc.Input(
                                    placeholder="Ex.: Gasolina, petshop...",
                                    id="txt-despesa"),
                            ], width=6),
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                ...
                                dbc.Select(
                                    id='select_despesa',
                                    options=[{'label': i, 'value': i} for i in globals.cat_despesa],
                                    value=globals.cat_despesa[0]
                                )
                            ], width=4)
                        ], style={'margin-top': '25px'}),
                        ...
                        dbc.Row([
                            ...
                            dbc.ModalFooter([
                                dbc.Button("Adicionar Despesa", id="salvar_despesa",
                                           color="success"),
                                dbc.Popover(dbc.PopoverBody("Despesa Salva"),
                                            target="salvar_despesa", placement="left",
                                            trigger="click"),
                            ])
                        ], style={'margin-top': '25px'})
                    ])
